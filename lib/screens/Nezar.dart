...
class Nezar extends StatelessWidget {
  const Nezar({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: SizedBox(
                  ...
                  height: 155,
                  child: Image.
                  asset('assets/images/nezar.png',
                  ),
                ),
              ),
              SizedBox(height: 6,),
              Text('DR/ Nezar Eltarras',
                style: TextStyle(
              ...
              Padding(
                ...
                child: SizedBox(
                    ...
                    width: 376,
                    child: Image.
                    asset('assets/images/nezar_bio.png')),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 50),
                child: InkWell(
                  onTap: ()async{
                    final phoneNumber='01201432441';
