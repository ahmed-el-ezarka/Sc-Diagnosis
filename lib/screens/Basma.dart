...
class Basma extends StatelessWidget {
  const Basma({Key? key}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: SizedBox(
                  ...
                  height: 140,
                  child: Image.
                  asset('assets/images/basma.png'),
                ),
              ),
              SizedBox(height: 6,),
              Text('DR/ Basma Abdelrahim',
                style: TextStyle(
              ...
              Padding(
                ...
                child: SizedBox(
                    ...
                    width: 376,
                    child: Image.
                    asset('assets/images/basma_bio.png')),
              ),
              Padding(
                padding: const EdgeInsets.only(top: 50),
                child: InkWell(
                  onTap: ()async{
                    final phoneNumber='01111685810';
